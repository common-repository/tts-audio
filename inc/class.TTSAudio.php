...
class TTSAudio{
  ...
  public function ttsAudioContent( $content ) {
    ...
    $cpr = sprintf('<a class="ttsaudio-plyr--single__info" title="%s" href="%s" target="_blank"></a>', 'TTS Audio by LayoutUp', 'https://layoutup.com');
    ...
    $player = sprintf($string_html, esc_attr( $this->options['plyr_skin'] ), get_the_ID(), esc_url_raw($mp3_url), apply_filters('gt_player_copyrights', $cpr));
  ...
  public static function author(){
    ...
    $output .=  sprintf('<a href="%1$s" title="%2$s" target="_blank">%2$s</a>', 'https://layoutup.com', 'TTS Audio by LayoutUp');
    $output .= '</div>';
